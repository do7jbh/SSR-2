...
class ILI9341_t3 : public Print
{
  public:
	...
	void ScrollAreaDefinition(uint16_t TopFixedArea, uint16_t VerticalScrollingArea, uint16_t BottomFixedArea);
		
	void ColumnRowSetAdress(uint16_t ColumnSetAdressStart, uint16_t ColumnSetAdressEnd, uint16_t RowSetAdressStart, uint16_t RowSetAdressEnd);
	void scrollOff(void);
